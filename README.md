...
For more info read `https://reactnative.dev/docs/getting-started`# echosphere git init git add . git commit -m first commit git branch -M main git remote add origin https://github.com/techcelerant/echosphere.git git push -u origin main
# echosphere
